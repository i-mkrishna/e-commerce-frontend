...
const FilterSidebar = () => {
    ...
    const brands = ["Urban Threads", "Modern fit", "Street Style", "Beach Breeze", "Fashion Style", "Nike"];

    const colors = ["Red", "Blue", "Green", "Black", "Yellow", "Gray", "Orange", "Pink", "Beige", "Navy"];
        ...
        <div className="p-4">
            ...
            <div className="mb-8">
                ...
                <input
                    ...
                    //     handleFilterChange({
                    //         target: { name: "maxPrice", value, type: "range" },
                    //     });
                    // }} 
