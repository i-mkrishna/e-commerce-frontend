...
const MyOrderPage = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto p-4 sm:p-6">
            <h2 className="text-xl sm:text-2xl font-bold mb-6">My oders</h2>
                                ...
                                <tr key={order._id} onClick={() => handleRowClick(order._id)} className="border-b hover:border-gray-50 cursor-pointer">
                                    <td className="py-2 px-2 sm:py-4 sm:px-4">
                                        <img src={order.orderItems[0].images} alt={order.orderItems[0].name}
                                            className="w-10 h-10 sm:w-12 sm:h-10 object-cover rounded-lg"
                                        />
                                    </td>
                                    ...
                                    <td className="py-2 px-2 sm:py-4 sm:px-4">
                                        {order.shippingAdd ? `${order.shippingAdd.city},${order.shippingAdd.country}` : "N/A"}
                                    </td>
